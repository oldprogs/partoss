...
unsigned long firstkey = 0, secondkey = 0, firsttest =
  0xffffffffL, secondtest = 0xffffffffL;
...
unsigned short dupecur = 0, dupemax = 0, local = 0, netmail = 0, flags2 =
  0, lkludnum = 0, lkludlen = 0, gkludlen = 0;
...
short pkt = 0, setf = 0, numpack = 0, dupreserv = 0, logfile = 0, tempsrv =
  0, thelp = 0, crtrep = 0, prttemp = 0;
long pctrlpos = 0, ptolen = 0, pfromlen = 0, psubjlen = 0, ptextlen =
  0, pmsglen = 0, pbigmess = 0, pcmsglen = 0;
long sctrlpos = 0, stolen = 0, sfromlen = 0, ssubjlen = 0, stextlen =
  0, smsglen = 0, sbigmess = 0, scmsglen = 0;
long mctrlpos = 0, mtolen = 0, mfromlen = 0, msubjlen = 0, mtextlen =
  0, mmsglen = 0, mbigmess = 0, rmbigmess = 0;
...
short endinput[4], endblock[4], endstring[4], numcr[4], toklen = 0, needout =
  0, fatmode = 0;
short mainset = 0, areaset = 0, areandx = 0, areadesc = 0, areapool =
  0, arcset = 0, compset = 0, packset = 0, linkset = 0, numarea = 0, pos =
  0, arealen = 0, ttempl = 0;
short arealenold = 0;
short badlocked = 0, dupelocked = 0, mustdie, maxtaglen = 0, globbad = 0;
unsigned short fmax = 0, buflen = 0, pcurpos = 0, scurpos = 0, both =
  0, rescan = 0, carea = 0, linktype = 0;
unsigned short pkludnum = 0, skludnum = 0, mkludnum = 0, pkludlen =
  0, skludlen = 0, mkludlen = 0;
unsigned curspos[4], curtpos[4], maxpos = 0, maxstr[4], maxstr2[4], maxlen[4];
long pointer = 0, poffset = 0, soffset = 0, ndxlen = 0, times = 0, arclen =
  0, globold = 0, globnew = 0;
...
char *pktbuf = NULL, *sqdbuf = NULL, *sbuffer[4], *string = NULL, *token =
  NULL, *point = NULL, tstrtime[40];
char curarea[arealength], rcurarea[arealength], oldarea[arealength],
...
short logfileok = 0;
char logout[BufSize + 1], *tail = NULL, *tbuffer =
  NULL, temppktn[DirSize + 1], tempsqdn[DirSize + 1];
...
int main (int argc, char **argv)
{
  ...
  forsed = 0;
  bufsqi = 256;
  short i, asis, tpost = 0, sinv = 0, pinv = 0, tmode = 0, killlog =
    0, fastlink = 0;
  long loglen = 0;
  ...
  char hfile[DirSize + 1], badname[DirSize + 1], tmpname[DirSize + 1], *temp =
    NULL;
