...
struct dostime
{
  unsigned day, month, year, sec, min, hour;
};
...
char *string, *token, sbuffer[256], *tstrtime, ftstime[20];
char *duotrice = "0123456789abcdefghijklmnopqrstuv";
char *months[12] =
  { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct",
"Nov", "Dec" };
int packset, key, logfile, toklen, maxstr, maxlen, curspos, endinput,
  endblock, endstring, curtpos;
unsigned long firstkey, secondkey;
unsigned long namehash, namecrc, addrhash, addrcrc;
char regname[80], regsaddr[80], logout[256];
time_t sftime;
struct tm *tmt;
