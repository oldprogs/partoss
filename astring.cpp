...
bool astring::compareic(const astring & rhs) const
{
  if(length != rhs.len())
    return false;
...
int astring::icpos(const astring & rhs) const
{
  int i;
...
astring astring::getword(char Delimiter, int Cnt, bool Soft) const
{
